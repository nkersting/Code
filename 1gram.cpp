...
void google_analyze(std::vector<string> wordlist)
{
 ...
 //    if (i%100000 == 0) cout << i << endl;
  ...
  //  
    ...
    ofstream outfile;
    outfile.open("D:\\website\\detropy.txt");
	//outfile.open("detropy.txt");
  ...
  //// below we compute moments
	  ...
	  ofstream outfile2;
      outfile2.open("D:\\website\\moments.txt");
	 //  outfile2.open("moments.txt");
...
//	 outfile2.open("testout.html");
    ...
    cout << "<p>Submission processed! If you wish to retrieve the numerical results of the computation,"
		<< "click <a href=\"../detropy.txt\">here</a> and <a href=\"../moments.txt\">here</a>. For your"
    ...
    cout << "<script src=\"../detropy.txt\" type=\"text/javascript\"></script>\r\n";
    ...
    cout << "<p> The plot below shows moments describing symmetry of the words in the above Detropy plot, "
		<< "i.e. A_N = \Sum_j {D_j * cos(N Pi j/L)}, 1 <= j <= L (D_j is detropy of the j-th word) which are convolutions of the above plot with "
		<< " discrete Fourier factors, normalized to A_0 (the total detropy).\r\n";
    ...
    cout << "<script src=\"../moments.txt\" type=\"text/javascript\"></script>\r\n";
...
int _tmain(int argc, _TCHAR* argv[])
{
 ...
 //input_words.push_back("one");
 //input_words.push_back("tw%2Co");
 //input_words.push_back("three");
 //input_words.push_back("four%26");
 //input_words.push_back("%22%22five%22");
 //input_words.push_back("six");
 //input_words.push_back("seven");
 //input_words.push_back("eight");
 //input_words.push_back("nine");
 // input_words.push_back("ten");
 //input_words.push_back("eleven");
 //input_words.push_back("twelve");
 //input_words.push_back("thirteen");
 //input_words.push_back("fourteen");
 //input_words.push_back("fifteen");
 //input_words.push_back("sixteen");
 //input_words.push_back("seventeen");
