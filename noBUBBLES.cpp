...
void WriteNoBubblePage()
{
  ...
  cout << "</head>\r\n";
  cout << "<body>\r\n";
  cout << "<p>Below you see all contributions thus far (as small numbers) and their position in XY color-space as well as lines indicating percent overlap: "
       << " the darker the line, the higher the percent overlap (hover over a line to see the exact overlap)."
       << " To show the bubbles again, click on the Show Bubbles button.</p>\r\n";
  cout << "<p>&nbsp;</p>\r\n";



  cout << "<form action=\"/cgi-bin/showBUBBLES.cgi\" method=\"post\" name=\"LineForm\"  align=\"center\" >\r\n";
  cout << "<input type=\"submit\" name=\"recalc\" value=\"Show Bubbles\"/>\r\n";
  cout << "</form>\r\n";
...
// first write bubble plot
  ...
  cout << "<script type=\"text/javascript\" src=\"../norgb.js\"></script>\r\n";
