...
/*
   ...
   for (map<string, set<int> >::iterator itx = keyLists.begin();
...
*/
   ...
   fstream filestr;
   filestr.open (DATADIR_LINES, fstream::out | fstream::trunc);
        ...
        itx != keyLists.end(); ++itx)
   {
      ...
      for (map<string, set<int> >::iterator ity = keyLists.begin();                                                    
      ...
      { 
         ...
         {
            filestr << x1 << " " << y1 << " " << x2 << " " << y2 << " " << overlap << " " << xcount << " " << ycount << endl;
         }
      }
